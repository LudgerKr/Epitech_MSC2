...
for episode in range(total_episodes):
    ...
    for step in range(max_steps):
        ...
        # Update Q(s,a):= Q(s,a) + lr [R(s,a) + gamma * max Q(s',a') - Q(s,a)] qtable[new_state,:] : all the actions
        # we can take from new state qtable[state, action] = qtable[state, action] + learning_rate * (reward + gamma
